      ...
      <div className="box1">
        <div className="box boxIn2">
          <div>
            ...
            <Link className="seeOffer" to="/products">
              ...
              <div>
                <div>
                  <Link to="/products">
                    ...
                    <div>
                      <span>Budget | Under RS 10,000</span>
                    </div>
                  </Link>
                </div>
                <div>
                  <Link to="/products">
                    ...
                    <div>
                      <span>Mid range | RS 10,000 - RS 25,000</span>
                    </div>
                  </Link>
                </div>
              </div>
              ...
              <div>
                <div>
                  <Link to="/products">
                    ...
                    <div>
                      <span>Premium | RS 25,000 - 40,000</span>
                    </div>
                  </Link>
                </div>
                <div>
                  <Link to="/products">
                    ...
                    <div>
                      <span>Ultra Premium | Above RS 40,000</span>
                    </div>
                  </Link>
                </div>
              </div>
              ...
              <div>
                <div>
                  <Link to="/products">
                    ...
                    <div>
                      <span>Home decor & essentials</span>
                    </div>
                  </Link>
                </div>
                <div>
              ...
              <div>
                ...
                <div>
                  <Link to="/products">
                    ...
                    <div>
                      <span>Under RS 599 | Clothing, shoes & more</span>
                    </div>
                  </Link>
                </div>
              </div>
              ...
              <div>
                <div>
                  <Link to="/products">
                    ...
                    <div>
                      <span>iPhone 14 | Starting RS 89</span>
                    </div>
                  </Link>
                </div>
                <div>
                  <Link to="/products">
                    ...
                    <div>
                      <span>Samsung Galaxy S22 | Starting RS 79</span>
                    </div>
                  </Link>
                </div>
              </div>
              ...
              <div>
                <div>
                  <Link to="/products">
                    ...
                    <div>
                      <span>OnePlus Nord CE 3 Lite | Starting RS 79</span>
                    </div>
                  </Link>
                </div>
                <div>
                  <Link to="/products">
                    ...
                    <div>
                      <span>Redmi 12C | Starting RS 79</span>
                    </div>
                  </Link>
                </div>
              </div>
      ...
      {loginPopUp && (
        <div className="modal signUp">
          ...
          <div className="signUp_account " id="signUp">
            <img src={amazonLogo} alt="404 Error" />
