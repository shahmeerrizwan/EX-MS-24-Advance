...
export default function Navbar() {
  ...
  const errMessage = () => {
    Swal.fire({
      ...
      footer:
        '<Link to="https://firebase.google.com/docs/auth">Why do I have this issue?</Link>',
    });
  };
  ...
  const handleAuthError = (error: any) => {
    ...
    Swal.fire({
      ...
      text: errorMessage,
      footer:
        '<a href="https://firebase.google.com/docs/auth/admin/errors" target="_blank">Why do I have this issue?</a>',
    });
  };
  ...
  return (
    <>
      <div className="header">
        <Link to="/">
          {" "}
          <img className="header__logo pc" src={amazonLogo} alt="..." />
        </Link>
        <div className="loc">
          <div className="loc-1">
        ...
        <div className="header__nav">
          {isLoggedInWithEmail ? (
              ...
              {toggleProfile && (
                <div id="user-dropdown" className="dropdown-content ">
                  ...
                  <div className="items">
                    <hr />
                    <Link to="">
                      <img src={myadd} alt="My Ads" /> My ads
                    </Link>
                    <Link to="">
                      <img src={Saved} alt="Favourites & Saved" /> Favourites &
                      Saved searches
                    </Link>
                    <Link to="">
                      <i className="fa-solid cent fa-eye"></i> Public Profile
                    </Link>
                    <Link to="">
                      <img src={Discount} alt="Discounted Packages" /> Buy
                      Discounted Packages
                    </Link>
                    <hr />
                    <Link to="">
            ...
            <div className="header__option">
              ...
              <span className="header__optionLineTwo" onClick={ToggleRegModal}>
                Sign In
              </span>
            </div>
          )}
              ...
              <aside>
                <div className="summary">
                  <div className="summary-total-items">
                    <span className="total-items"></span> Items in your Cart
                  </div>
                  <div className="summary-subtotal">
                    <div className="subtotal-title">Subtotal</div>
                    <div className="subtotal-value final-value">
                      ${total.toFixed(2)}
                    </div>
        ...
        <div className="modal">
          ...
          <div className="login" id="login">
            <div className="login_form">
              <div className="m-l">
                <img className="modal-logo" src={amazonLogo} alt=" Logo" />
              </div>
              ...
              <button className="loginSign_button" onClick={ToggleSignup}>
                <img src={google} alt="Google Icon" /> Create Your Account
              </button>
      ...
      <div className="head-2">
        <input
          className="header__searchInput inp-2"
          value={searchQuery}
          onChange={handleSearchChange}
